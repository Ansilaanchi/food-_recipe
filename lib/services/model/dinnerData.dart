      ...
      body: SafeArea(
        ...
        child: Container(
          ...
          decoration: BoxDecoration(
            image: DecorationImage(image: AssetImage("assets/brown-backgrounds-15181888.webp"),fit: BoxFit.cover),
...
class DinnerData extends StatefulWidget {
  final String recipeId; // Your user ID

  DinnerData( this.recipeId);

  @override
  State<DinnerData> createState() => _DinnerDataState();
}

class _DinnerDataState extends State<DinnerData> {
  @override
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
      ...
      body: FutureBuilder<DocumentSnapshot>(
        future: FirebaseFirestore.instance.collection('dinner').doc(widget.recipeId).get(),
