...
import 'package:foodie_zone/services/model/brunchData.dart';
import 'package:foodie_zone/services/model/recipe.model.dart';

class Brunch extends StatefulWidget {
 

   Brunch({super.key});

  @override
  State<Brunch> createState() => _BrunchState();
}

class _BrunchState extends State<Brunch> {
  final String userId = "";

  @override
  Widget build(BuildContext context) {
    return StreamBuilder(
      stream: FirebaseFirestore.instance.collection("brunch").snapshots(),
      builder: (context,
